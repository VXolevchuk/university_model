...
public class CourseController {
	...
	@PostMapping("add")
	public ResponseEntity<ResultDTO> addCourse(@RequestBody CourseDTO courseDTO) {
		courseService.addCourse(courseDTO);
		return new ResponseEntity<>(new SuccessResult(), HttpStatus.OK);	
	}
	
	@PostMapping("delete")
	public  ResponseEntity<ResultDTO> deleteCourse(@RequestParam(name = "id", required = false) Long id) {
